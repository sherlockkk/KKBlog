...
(function () {
    ...
    MT('image',
        'An img: [string !http://www.example.com/img.png!]');

    MT('imageWithAltText',
        'An img: [string !http://www.example.com/img.png (Alt Text)!]');

    MT('imageWithUrl',
        'An img: [string !http://www.example.com/img.png!:http://www.example.com/]');
